...
app.post('/upload-photo', upload.single('photo'), (req, res) => {
  if (req.file) {
    // Тут ви можете зберегти інформацію про фото в базу даних, як ви робили з GIF.

    res.send('Photo successfully uploaded and saved.');
  } else {
    res.status(400).send('Error: Photo was not uploaded.');
  }
});
